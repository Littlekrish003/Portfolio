...
import { Mail, Lock, Eye, EyeOff, Cloud, ArrowRight, Loader2, Chrome } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-cover bg-center" style={{backgroundImage: 'url(/auth-login-left.jpg)'}}></div>
          ...
          <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-gradient-primary hover:opacity-90 transition-opacity text-base font-medium group"
              >
                {isLoading ? (
                  <Loader2 className="w-5 h-5 animate-spin" />
                ) : (
